...
public class MainActivity extends ActionBarActivity implements ActionBar.TabListener {
    ...
    private void sensitiveCamera() {
        CameraManager manager = getSystemService(CameraManager.class);
        try {
            manager.openCamera("1", null, null);
    ...
    private void sensitiveLocation() {
        MyGPSLocation myGPSLocation = new MyGPSLocation(this);
        myGPSLocation.dangerous();
    }
